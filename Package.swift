...
let package = Package(
    ...
    dependencies: [
        .package(url: "https://github.com/armongate-dev/mobileaccess-core.git", exact: "0.0.3-beta.11"),
        .package(url: "https://github.com/armongate-dev/mobileaccess-sdk.git", exact: "0.0.3-beta.11")
    ],
    targets: [
        .target(
            name: "ArmongateMobileAccess",

...
let package = Package(
    ...
    dependencies: [
        .package(url: "https://github.com/armongate-dev/mobileaccess-core.git", exact: "0.0.2-beta.34"),
        .package(url: "https://github.com/armongate-dev/mobileaccess-sdk.git", exact: "0.0.2-beta.34")
    ],
    targets: [
        .target(
            name: "ArmongateMobileAccess",
